      ...
      <div class="content flex-wrap">
        ...
        <div class="c-right">
          ...
          <div class="button-wrap flex-wrap">
            <div class="button r-button" v-if="this.$route.query.title === 'Upcoming'">Confirm</div>
            <div class="button r-button" v-else-if="this.$route.query.title === 'Completed'">Delete</div>

            <div class="button r-button" @click="cancel" v-if="this.$route.query.title === 'Upcoming'">Cancel</div>
          </div>
        </div>
      </div>
